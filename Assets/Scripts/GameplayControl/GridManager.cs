...
public class GridManager : MonoBehaviour
{
    ...
    public void GenerateMap() 
    {
        ...
        MeshCollider meshCollider = map.gameObject.GetComponent<MeshCollider>();
    ...
    public void GenerateTileProps()
    {
        ...
        Debug.LogFormat("{0} tiles initialized.", tileProps.Length.ToString());
    }
    ...
    public void GeneratePlayers()
    {
        ...
        for (int i = 0; i < numberOfPlayers; i++)
        {
            ...
            for (int j = 0; j < startingPopulation; j++)
            {
                ...
                vill.GetComponent<UnitCitizen>().OnBorn(i, "Villager");
